...
from tests.support.helpers import PRE_PYTEST_SKIP_REASON, PRE_PYTEST_SKIP_OR_NOT, _check_required_sminion_attributes
...
def pytest_runtest_setup(item):
    ...
    if requires_salt_modules_marker is not None:
        ...
        not_available_modules = _check_required_sminion_attributes('functions', required_salt_modules)
    ...
    if requires_salt_states_marker is not None:
        ...
        not_available_states = _check_required_sminion_attributes('states', required_salt_states)
